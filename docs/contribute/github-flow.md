<!-- Space: Projects -->
<!-- Parent: ZshZed -->
<!-- Title: Contributing GithubFlow ZshZed -->
<!-- Label: ZshZed -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-zed project on [GitHub](https://github.com/hadenlabs/zsh-zed), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-zed/pulls).
...
To follow the instructions in this guide and start contributing to zsh-zed project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-zed.git
```

Now your **upstream** points to **hadenlabs/zsh-zed**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-zed
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-zed/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
